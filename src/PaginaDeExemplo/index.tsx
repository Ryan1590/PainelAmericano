                ...
                <div className={styles.border}>
                    ...
                    <form className='needs-validation align-items-center' noValidate onSubmit={submitForm} ref={refForm}>
                        ...
                        <div className='col-md-12 mt-3'>
                            ...
                            <button className='btn btn-warning w-100' type='button' id='botao' onClick={() => { setEstado(estado + 1); }}>
                                Estado
                            </button>
                            <button className='btn btn-warning w-100' type='button' id='botao' onClick={() => { refContador.current = refContador.current + 1; }}>
                                Ref
                            </button>
                        </div>
                    </form>
